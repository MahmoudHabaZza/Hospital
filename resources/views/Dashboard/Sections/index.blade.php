...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Pages</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/sections.sections') }}</span>
						</div>
					</div>
                                ...
                                <table class="table text-md-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">{{ trans('Dashboard/sections.operations') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
{{-- Include Notify Js Package => messages alert --}}
